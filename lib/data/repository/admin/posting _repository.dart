...
import 'package:ternak_kenari_app/data/model/request/admin/posting_jual_request_model.dart';
import 'package:ternak_kenari_app/data/model/response/burung_semua_tersedia_model.dart';
import 'package:ternak_kenari_app/data/model/response/get_all_burung_response_model.dart';
...
class PostingRepository {
  ...
  Future<Either<String, BurungSemuaTersediabyIdModel>> addPotBurung(
    ...
    try {
      ...
      return Left("Error in Add burung: $e");
    }
  }
  ...
  Future<Either<String, GetAllBurungModel>> getAllBurung() async {
    try {
      ...
      return Left("Error in getting all burung: $e");
    }
  }
}
